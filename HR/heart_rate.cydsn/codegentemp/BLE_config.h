...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_UUID_16   (0x08u)
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_DATA_LED_CHANGE   (0x10u)
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_DATA_ADCVAL   (0x14u)
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_DATA_TEMPERATURE   (0x18u)
 ...
 */
#define CY_BLE_LED_CHANGE_SERVICE_INDEX   (0x00u) /* Index of LED Change service in the cy_ble_customs array */
#define CY_BLE_LED_CHANGE_LED_CHAR_INDEX   (0x00u) /* Index of LED characteristic */
#define CY_BLE_LED_CHANGE_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_ADCVAL_SERVICE_INDEX   (0x01u) /* Index of ADCVal service in the cy_ble_customs array */
#define CY_BLE_ADCVAL_ADC_CHAR_INDEX   (0x00u) /* Index of ADC characteristic */
#define CY_BLE_ADCVAL_ADC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_TEMPERATURE_SERVICE_INDEX   (0x02u) /* Index of Temperature service in the cy_ble_customs array */
#define CY_BLE_TEMPERATURE_TEMPERATURE_CHAR_INDEX   (0x00u) /* Index of Temperature characteristic */
#define CY_BLE_TEMPERATURE_TEMPERATURE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_LED_CHANGE_SERVICE_HANDLE   (0x0010u) /* Handle of LED Change service */
#define CY_BLE_LED_CHANGE_LED_DECL_HANDLE   (0x0011u) /* Handle of LED characteristic declaration */
#define CY_BLE_LED_CHANGE_LED_CHAR_HANDLE   (0x0012u) /* Handle of LED characteristic */
#define CY_BLE_LED_CHANGE_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_ADCVAL_SERVICE_HANDLE   (0x0014u) /* Handle of ADCVal service */
#define CY_BLE_ADCVAL_ADC_DECL_HANDLE   (0x0015u) /* Handle of ADC characteristic declaration */
#define CY_BLE_ADCVAL_ADC_CHAR_HANDLE   (0x0016u) /* Handle of ADC characteristic */
#define CY_BLE_ADCVAL_ADC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0017u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_TEMPERATURE_SERVICE_HANDLE   (0x0018u) /* Handle of Temperature service */
#define CY_BLE_TEMPERATURE_TEMPERATURE_DECL_HANDLE   (0x0019u) /* Handle of Temperature characteristic declaration */
#define CY_BLE_TEMPERATURE_TEMPERATURE_CHAR_HANDLE   (0x001Au) /* Handle of Temperature characteristic */
#define CY_BLE_TEMPERATURE_TEMPERATURE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Bu) /* Handle of Characteristic User Description descriptor */
