...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x04u, 0x09u, 0x50u, 0x50u,
        0x47u, 0x07u, 0x03u, 0x11u, 0xE2u, 0x11u, 0xAAu,
        0xFCu, 0xFDu, 0x03u, 0x16u, 0x11u, 0xE2u, 0x03u,
        0x16u, 0x11u, 0xAAu, 0x03u, 0x16u, 0xFCu, 0xFDu,
...
static uint8_t cy_ble_attValues[0x41u] = {
    /* Device Name */
    (uint8_t)'P', (uint8_t)'P', (uint8_t)'G', 
    ...
    (uint8_t)'L', (uint8_t)'E', (uint8_t)'D', (uint8_t)' ', (uint8_t)'C', (uint8_t)'h', (uint8_t)'a', (uint8_t)'n',
(uint8_t)'g', (uint8_t)'e', (uint8_t)' ', (uint8_t)'(', (uint8_t)'1', (uint8_t)'-', (uint8_t)'3', (uint8_t)')', 

    /* ADC */
    0x00u, 0x00u, 0x00u, 0x00u, 

    /* Characteristic User Description */
    (uint8_t)'A', (uint8_t)'D', (uint8_t)'C', (uint8_t)' ', (uint8_t)'V', (uint8_t)'a', (uint8_t)'l', (uint8_t)'u',
(uint8_t)'e', 
    ...
    /* Characteristic User Description */
    (uint8_t)'T', (uint8_t)'e', (uint8_t)'m', (uint8_t)'p', (uint8_t)'e', (uint8_t)'r', (uint8_t)'a', (uint8_t)'t',
(uint8_t)'u', (uint8_t)'r', (uint8_t)'e', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Du] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[19] }, /* LED */
    { 0x0010u, (void *)&cy_ble_attValues[20] }, /* Characteristic User Description */
    { 0x0004u, (void *)&cy_ble_attValues[36] }, /* ADC */
    { 0x0009u, (void *)&cy_ble_attValues[40] }, /* Characteristic User Description */
    { 0x0005u, (void *)&cy_ble_attValues[49] }, /* Temperature */
    { 0x000Bu, (void *)&cy_ble_attValues[54] }, /* Characteristic User Description */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x1Bu] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0013u, {{0xE211u, NULL}}                           },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00080001u /* wr    */, 0x0013u, {{0x4734u, NULL}}                           },
    { 0x0012u, 0x4734u /* LED                                 */, 0x01080100u /* wr    */, 0x0013u, {{0x0001u, (void *)&cy_ble_attValuesLen[7]}} },
    { 0x0013u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x0013u, {{0x0010u, (void *)&cy_ble_attValuesLen[8]}} },
    { 0x0014u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0017u, {{0xAA11u, NULL}}                           },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0017u, {{0x7DF3u, NULL}}                           },
    { 0x0016u, 0x7DF3u /* ADC                                 */, 0x01020001u /* rd    */, 0x0017u, {{0x0004u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0017u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x0017u, {{0x0009u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0018u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x001Bu, {{0xFDFCu, NULL}}                           },
    { 0x0019u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x001Bu, {{0x855Fu, NULL}}                           },
    { 0x001Au, 0x855Fu /* Temperature                         */, 0x01020001u /* rd    */, 0x001Bu, {{0x0005u, (void *)&cy_ble_attValuesLen[11]}} },
    { 0x001Bu, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x001Bu, {{0x000Bu, (void *)&cy_ble_attValuesLen[12]}} },
};
