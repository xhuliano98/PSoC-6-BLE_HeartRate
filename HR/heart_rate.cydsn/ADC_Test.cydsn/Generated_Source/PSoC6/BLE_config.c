...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x09u, 0x09u, 0x41u, 0x44u,
        0x43u, 0x5Fu, 0x54u, 0x65u, 0x73u, 0x74u, 0x11u,
        0x21u, 0x2Bu, 0xE8u, 0x87u, 0xFDu, 0x9Fu, 0x3Cu,
        0x7Eu, 0x87u, 0xCFu, 0x4Du, 0xA2u, 0xE1u, 0x73u,
        0xDDu, 0xB7u, 0xEBu }, /* uint8_t advertising_data[CY_BLE_MAX_ADV_DATA_LEN] */ 
...
static uint8_t cy_ble_attValues[0x1Au] = {
    /* Device Name */
    (uint8_t)'A', (uint8_t)'D', (uint8_t)'C', (uint8_t)'_', (uint8_t)'T', (uint8_t)'e', (uint8_t)'s', (uint8_t)'t', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Custom Service */
    { 0x2Bu, 0xE8u, 0x87u, 0xFDu, 0x9Fu, 0x3Cu, 0x7Eu, 0x87u, 0xCFu, 0x4Du, 0xA2u, 0xE1u, 0x73u, 0xDDu, 0xB7u, 0xEBu },
};

static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x09u] = {
    ...
    { 0x0002u, (void *)&cy_ble_attValues[24] }, /* Custom Characteristic */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x12u] = {
    ...
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0012u, {{0x6467u, NULL}}                           },
    { 0x0012u, 0x6467u /* Custom Characteristic               */, 0x01020001u /* rd    */, 0x0012u, {{0x0002u, (void *)&cy_ble_attValuesLen[8]}} },
};
