...
static const cy_stc_ble_customs_t cy_ble_customs[0x03u] = {
    ...
    /* LED Change service */
    {
        0x0010u, /* Handle of the LED Change service */ 
        {
    ...
    /* ADCVal service */
    {
        0x0014u, /* Handle of the ADCVal service */ 
        {

            /* ADC characteristic */
            {
                0x0016u, /* Handle of the ADC characteristic */ 
    ...
    /* Temperature service */
    {
        0x0018u, /* Handle of the Temperature service */ 
        {

            /* Temperature characteristic */
            {
                0x001Au, /* Handle of the Temperature characteristic */ 
